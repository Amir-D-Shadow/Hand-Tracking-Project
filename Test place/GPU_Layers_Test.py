        ...
        for n_h in range(nH):
          ...
          for n_w in range(nW):
            ...
            if (n_w == n_w_tail) or (n_h == n_h_tail):
              ...
              if (n_w == n_w_tail) and (n_h == n_h_tail):
                ...
                #Tail
                IMG_H_tail = n_h_tail*stride + h
                IMG_W_tail = n_w_tail*stride + w

                dW[h,w,n_C_prev,n_c] = dW[h,w,n_C_prev,n_c] + A_prev_pad[i,IMG_H_tail,IMG_W_tail,n_C_prev]*dZ[i,n_h_tail,n_w_tail,n_c]
              ...
              dW[h,w,n_C_prev,n_c] = dW[h,w,n_C_prev,n_c] + A_prev_pad[i,IMG_H_tail,IMG_W,n_C_prev]*dZ[i,n_h_tail,n_w,n_c]

              #calculate botton left hand corner
              dW[h,w,n_C_prev,n_c] = dW[h,w,n_C_prev,n_c] + A_prev_pad[i,IMG_H,IMG_W_tail,n_C_prev]*dZ[i,n_h,n_w_tail,n_c]
